...
import { MemoryPromptContextService } from "./application/memory-prompt-context.service.js";

@Module({
  imports: [LoggerModule, ProjectsModule, MemoriesModule],
  providers: [ChatPromptService, ChatTokenBudgetService, ProjectChatContextService, MemoryPromptContextService],
